#!/bin/bash
# Two-step GB200 smoke test for the per-token NVFP4 W4A4 rollout:
# BF16 Megatron training, weights NVFP4-quantized in-flight at refit, vLLM
# per-token dynamic activation scales (quantization=nvfp4_pertoken).
